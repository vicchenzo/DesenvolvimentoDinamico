...
// Declare uma variável para armazenar o nome de uma cidade e outra para armazenar a sua população. Exiba uma mensagem combinando ambas as variáveis
let cidade = 'Gold Coast'
let population = 100
console.log(`Eu vou morar na Austrália em ${cidade} e a populacao é de ${population}k habitantes.`)
