...
//Definicao de operadores em programacao
//Indica que vai acontecer uma operação na sua variável
//Simbolos ou palavras-chave especiais que permitem realziar operações em valores, variáveis ou expressões;
...
modulo(%): o valor do resto da divisão
exponencial(**):
incrementar(++): aumenta uma unidade do valor referido
decrementar(--): diminui uma unidade do valor referido
*/
